        ...
        wedding_location : function(){
            ...
            if( $('#map_extended').length ){
                ...
                $("#map_extended").gMap({
                    markers: [
                        {
                            html: '<div class="location-map"><i class="tamilweddingbook_wine"></i><h5>Wedding Party:<br>Grand Royale Resort</h5></div>',
                            latitude: -33.890542,
                        ...
                        {
                            html: '<div class="location-map"><i class="tamilweddingbook_heart_ring"></i><h5>Wedding Party:<br>Grand Royale Resort</h5></div>',
                            latitude: -33.923036,
