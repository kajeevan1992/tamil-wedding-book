// todo remove all these and do seating chart related actions here 
import { ROW, COLUMN, COMPONENT } from '@components/couple/seating-charts/constants';
    ...
    switch (splitDropZonePath.length) {
        case 1: {
            newLayoutStructure = {
                type: ROW,
                id: Math.floor(Math.random() * 10),
                children: [{ type: COLUMN, id: Math.floor(Math.random() * 10), children: [item] }]
            };
            break;
        }
        case 2: {
